      ...
      <main>
        <article className="max-w-[652px] mx-auto xl:pt-12">
          ...
          <div
            ...
            className="w-full mx-auto min-h-[200px] overflow-x-hidden px-6 py-18 sm:py-22 rounded-2xl bg-accent/25 ring-1 ring-border flex items-center justify-center overflow-hidden"
          >
            <UserBox />
          </div>
        </article>
